    ...
    <Stack direction={['column', 'row']} h={'100vh'}>
      <VStack w={'full'}>
        ...
        <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
          ...
          <Text>
            All lecture 1 to lecture 7 the videos given are sample videos for testing and Demo.
            Explore the future of artificial intelligence in this insightful explainer video.
            A must-watch for tech enthusiasts, professionals, and anyone interested in the evolving world of AI.
          </Text>
        </VStack>
      </VStack>
      <VStack
